...
def main():
    ...
    filename_fit = 'Augustus_16.hdf5'

    params = utilities.load_fit(os.path.join(path, filename_in))

    # Initial guess for the qubit parameters.
    # params = {'E_L1': 0.925,  # The inductive energy.
    #           'E_C1': 1.06,  # The charging energy.
    #           'E_J1': 3.6,  # The Josephson energy.
    #           'phi_ext1': [0.],
    #           'num_osc1': 50,
    #           'num_qbt1': 10,
    #           'E_L2': 1.639,  # The inductive energy.
    #           'E_C2': 1.014,  # The charging energy.
    #           'E_J2': 3.9665,  # The Josephson energy.
    #           'phi_ext2': [0.],
    #           'num_osc2': 50,
    #           'num_qbt2': 10,
    #           'E_int_chg': 0.35,
    ...
    phi_ext = np.linspace(0.42, 0.58, 21)
    phi_ext2 = np.linspace(0., 1, 21)
