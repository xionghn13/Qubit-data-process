...
def main():
    ...
    filename_in = 'one_mode_QD2_in_12GHz_cavity_1.hdf5'
    filename_fit = 'one_mode_QD2_in_12GHz_cavity_1.hdf5'

    params = utilities.load_fit(os.path.join(path, filename_in))

    # Initial guess for the qubit parameters.
    # params = {'E_L': 1, # The inductive energy.
    #           'E_C': 2.26, # The charging energy.
    #           'E_J': 13, # The Josephson energy.
    #           'phi_ext': [0.],
    #           'frequencies': [10.898], # Single mode frequencies.
    ...
    phi_ext = np.linspace(-0.1, 0.6, 281)
