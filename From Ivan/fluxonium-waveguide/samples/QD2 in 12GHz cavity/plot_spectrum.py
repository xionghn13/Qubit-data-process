...
def plot_spectrum():
    ...
    path_filenames = [
        'two tone_1024.hdf5',
        'two tone_1024_1.hdf5',
        'two tone_1024_2.hdf5',
        'two tone.hdf5',
        'two tone_2.hdf5',
        'two tone_5.hdf5',
        'one tone.hdf5',
    ...
    for path_filename in path_filenames:
        ...
        if n_entries != bias_size:
            if data_name == 'VNA - S21':
                ...
                for k in range(bias_size):
                    ...
                    bias_1d = d['Yoko-Roma - Current'] / 1.e-3
        ...
        plt.pcolormesh(bias_2d, freq_2d, plot_2d, cmap='PuBu', vmin=np.min(plot_2d), vmax=0.5)
        # print(np.min(plot_2d))
        # print(np.max(plot_2d))
